...
\newacronym{geom}{GEOM}{NeoGeo Geometry Ontology}
...
%DogOnt\footnote{\url{http://elite.polito.it/ontologies/dogont.owl}} is an ontology that aims to enable intelligent home automation. For this purpose it also includes concepts to model how the indoor environment is composed, whereas this is not the main focus; thus important elements of an indoor environment like corridors for example are missing.
